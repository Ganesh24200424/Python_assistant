...
ARCHITECTURE OVERVIEW:
  GroqService is the core LLM interface for ASTRO. It does three things:
...
FLOW:
  ...
  3. We build a system message: ASTRO_SYSTEM_PROMPT + current time + retrieved context.
...
def _log_timing(label: str, elapsed: float, extra: str = ""):
    ...
    with grep: `grep "[TIMING]" astro.log` shows all performance data.
    """
...
class GroqService:
    ...
    def __init__(self, vector_store_service: VectorStoreService):
        ...
        PARAMETERS EXPLAINED:
          - temperature=0.6: Controls randomness in the LLM's output.
            ...
            0.6 gives ASTRO a personality while staying coherent. This is
        ...
        self.llms = [
            ChatGroq(
                ...
                temperature=0.5,  # Slightly lower to reduce repetitive/rambling output
    ...
    #   Layer 1: Base personality (ASTRO_SYSTEM_PROMPT)
    ...
    def _build_prompt_and_messages(
        ...
        LAYER 1 — BASE PERSONALITY (ASTRO_SYSTEM_PROMPT):
          The core personality and instructions for ASTRO. Defines tone, behavior,
          and capabilities. Loaded from config.py. This is the "soul" of ASTRO —
        ...
        LAYER 3 — VECTOR STORE CONTEXT (RAG — Retrieval-Augmented Generation):
          ...
          This is what makes ASTRO personalized — it answers based on YOUR data.
        ...
        system_message = ASTRO_SYSTEM_PROMPT  # Layer 1: base personality
