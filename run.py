"""
RUN SCRIPT - Start the ASTRO server
=========================================
...
# -----------------------------------------------------------------------------
# STARTUP: Generate thinking audio (runs once before server starts)
# -----------------------------------------------------------------------------
# Creates frontend/audio/starter_*.mp3 for the "AI is thinking" sound
# during the wait before first token.
